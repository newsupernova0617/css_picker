...
## Usage
```
/sg:select-tool [operation] [--analyze] [--explain]
```
...
```
/sg:select-tool "rename function across 10 files" --analyze
...
```
/sg:select-tool "update console.log to logger.info across project" --explain
...
```
/sg:select-tool "save project context and discoveries"
